...
namespace Microsoft.Data.Entity.Scaffolding.Pluralization
{
    ...
    internal static class PluralizationServiceUtil
    {
        ...
        {
            return suffixes.Any(s => word.EndsWith(s, /*true, culture*/ StringComparison.OrdinalIgnoreCase));
        }
            ...
            string word, IEnumerable<string> suffixes, CultureInfo culture, out string matchedSuffix)
        {
            ...
            {
                matchedSuffix = suffixes.First(s => word.EndsWith(s, /*true, culture*/ StringComparison.OrdinalIgnoreCase));
                return true;
            }
            return false;
        }
